...
sun.addEventListener('click', () => {
    fetch(url)
        ...
        .then(data => {
            ...
            planetType.textContent = `Composicion: ${data[0].type}`
...
mercury.addEventListener('click', () => {
    fetch(url)
        ...
        .then(data => {
            ...
            planetType.textContent = `Composicion: ${data[1].type}`
...
venus.addEventListener('click', () => {
    fetch(url)
        ...
        .then(data => {
            ...
            planetType.textContent = `Composicion: ${data[2].type}`
...
earth.addEventListener('click', () => {
    fetch(url)
        ...
        .then(data => {
            ...
            planetType.textContent = `Composicion: ${data[3].type}`
...
mars.addEventListener('click', () => {
    fetch(url)
        ...
        .then(data => {
            ...
            planetType.textContent = `Composicion: ${data[4].type}`
...
jupiter.addEventListener('click', () => {
    fetch(url)
        ...
        .then(data => {
            ...
            planetType.textContent = `Composicion: ${data[5].type}`
...
saturn.addEventListener('click', () => {
    fetch(url)
        ...
        .then(data => {
            ...
            planetType.textContent = `Composicion: ${data[6].type}`
...
uranus.addEventListener('click', () => {
    fetch(url)
        ...
        .then(data => {
            ...
            planetType.textContent = `Composicion: ${data[7].type}`
...
neptune.addEventListener('click', () => {
    fetch(url)
        ...
        .then(data => {
            ...
            planetType.textContent = `Composicion: ${data[8].type}`
...
pluto.addEventListener('click', () => {
    fetch(url)
        ...
        .then(data => {
            ...
            planetType.textContent = `Composicion: ${data[9].type}`
